...
public class Constants {
    ...
    public static final String QUERY_REDO = "SELECT SCN, COMMIT_SCN, TIMESTAMP, COMMIT_TIMESTAMP, OPERATION, SEG_OWNER, TABLE_NAME, ROW_ID, CSF, SQL_REDO FROM  V$LOGMNR_CONTENTS  WHERE OPERATION_CODE IN (1,2,3,5) ";
